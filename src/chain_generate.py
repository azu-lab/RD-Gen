...
from src.builder.chain import generate_single_chain, vertically_link_chains, merge_chains
...
def generate(cfg, dest_dir):
    ...
    for dag_i in range(cfg['Number of DAGs']):
        ...
        for num_nodes_in_one_chain in chain_num_nodes_combo:
            chains.append(generate_single_chain(
                cfg, num_nodes_in_one_chain, G))
